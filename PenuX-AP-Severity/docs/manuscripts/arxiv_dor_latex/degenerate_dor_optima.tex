...
zou2007,fawcett2006}. \citet{hanley1982} established the now-standard
interpretation of AUC as the probability that a randomly chosen positive
case is ranked above a randomly chosen negative case, equivalent to the
Mann--Whitney $U$ statistic, a fact we use directly in
Section~\ref{sec:composite}. \citet{delong1988} gave the widely used
...
the interior restriction on a given sample. A closely related alternative
is to abandon ratio-based selection altogether in favor of decision curve
analysis \citep{vickers2006}, which selects a threshold by net clinical
benefit at a stated harm-to-benefit ratio rather than by any discrimination
statistic, or to report calibration-based measures alongside discrimination
...
Finally, we note that the natural-frequency framing recommended for
...
without requiring the proof given here.
